...
//#define MAX_TIME_ESCENA 160*1000 //tiempo maximo por defecto que está una escena en pantalla
#define MAX_TIME_ESCENA 100*1000 //tiempo maximo por defecto que está una escena en pantalla
